...
class ResettingController extends Controller {
    ...
    public function requestAction(Request $request) {
        return $this->render('LostAdminBundle:Resetting:request.html.twig');
    }
    ...
    public function sendEmailAction(Request $request) {
        ...
        if (null === $user) {
            ...
            return $this->redirect($this->generateUrl('lost_admin_password_resetting_request'));
        }
        $role = $user->getRoles();
        ...
        $url = $this->generateUrl('lost_admin_reset_password', array('token' => $user->getConfirmationToken()), true);
        $body = $this->container->get('templating')->renderResponse('LostAdminBundle:Resetting:email_resetting.html.twig', array('username' => $user, 'confirmationUrl' => $url));

        $resend_email_verification = \Swift_Message::newInstance()
                ->setSubject("Lost Portal Password Reset")
        ...
        return new RedirectResponse($this->generateUrl('lost_admin_resetting_check_email', array('email' => $this->getObfuscatedEmail($user))
        ));
    }
    ...
    public function checkEmailAction(Request $request) {
        ...
        return $this->render('LostAdminBundle:Resetting:checkEmail.html.twig', array(
                    'email' => $email,
        ));
    }
    ...
    public function resetAction(Request $request, $token) { 
        ...
        if ($form->isValid()) {
            ...
            if (null === $response = $event->getResponse()) {
                $url = $this->generateUrl('lost_admin_password_reset_success');
                $response = new RedirectResponse($url);
            }
        ...
        return $this->render('LostAdminBundle:Resetting:reset.html.twig', array(
                    'token' => $token,
    ...
    public function resetSuccessAction() {
        ...
        return $this->render('LostAdminBundle:Resetting:reset_success.html.twig');
    }
