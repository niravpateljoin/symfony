...
use Lost\AdminBundle\Form\Type\AdminServiceLocationFormType;
...
class AdminServiceLocationController extends Controller {
    ...
    public function indexAction(Request $request, $id) {
        ...
        return $this->render('LostAdminBundle:AdminServiceLocation:index.html.twig', array('form' => $form->createView(), 'id' => $id, 'user' => $user));
    }
