...
class SupportController extends Controller {
    ...
    public function indexAction(Request $request) {
        ...
        $query = $em->getRepository('LostUserBundle:Support')->getAllSupports();
        ...
        if (isset($searchParams)) {
            ...
            $query = $em->getRepository('LostUserBundle:Support')->getAllSupportsSearch($query, $searchParams);
        }

        $paginator = $this->get('knp_paginator');
        $pagination = $paginator->paginate($query, $request->query->get('page', 1), 10);

        $supportCategories = $em->getRepository('LostUserBundle:SupportCategory')->findAll();

        return $this->render('LostAdminBundle:Support:index.html.twig', array(
    ...
    public function changeStatusAction($id, $status) {
        ...
        $objSupport = $em->getRepository('LostUserBundle:Support')->find($id);
        ...
        return $this->redirect($this->generateUrl('lost_admin_support_list'));
    }
    ...
    public function viewAction($id) {
        ...
        return $this->render('LostAdminBundle:Support:view.html.twig', array(
                    'support' => $objSupport
        ));
    }
