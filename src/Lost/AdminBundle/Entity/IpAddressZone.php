 ...
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="Lost\AdminBundle\Repository\IpAddressZoneRepository")
...
class IpAddressZone
{
    ...
    /**
    *
    * @ORM\ManyToMany(targetEntity="Lost\UserBundle\Entity\Service", inversedBy="ipAddressZones")
    ...
    */
     ...
     * Set serviceLocation
     *
     * @param \Lost\AdminBundle\Entity\ServiceLocation $serviceLocation
     * @return IpAddressZone
     */
    public function setServiceLocation(\Lost\AdminBundle\Entity\ServiceLocation $serviceLocation = null)
    {
     ...
     * Get serviceLocation
     *
     * @return \Lost\AdminBundle\Entity\ServiceLocation 
     */
