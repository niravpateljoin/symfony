<?php
namespace Lost\ServiceBundle\Model;
...
class ExpressCheckout {
    ...
    function __construct($option,$container){
        ...
        $this->USERNAME     = $this->container->getParameter('paypal_username'); //Get Paypal Business Username
        $this->PASSWORD     = $this->container->getParameter('paypal_password'); //Get Paypal Business Password
        $this->SIGNATURE    = $this->container->getParameter('paypal_signature'); //Get Paypal Business Signature
        $this->PAYPALMODE   = $this->container->getParameter('paypal_mode'); //Get Paypal api mode
    }
    ...
    public function setExpressCheckout($paymentDetail){      
        ...
        $itemstring .= '&'.$this->processPayment($paymentDetail);
