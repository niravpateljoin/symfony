 ...
 * @ORM\Entity(repositoryClass="Lost\ServiceBundle\Repository\ServiceActivationFailureRepository")
 */
...
class ServiceActivationFailure {
     ...
     * @return ServiceActivationFailure
     */
    public function setServicePurchases(\Lost\ServiceBundle\Entity\ServicePurchase $servicePurchases = null)
    {
