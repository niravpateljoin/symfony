 ...
 * @ORM\Entity(repositoryClass="Lost\ServiceBundle\Repository\PaypalCheckoutRepository")
 */
...
class PaypalCheckout {
    ...
    /**
     *
     * @ORM\ManyToOne(targetEntity="Lost\UserBundle\Entity\User", inversedBy="paypalCheckouts")
    ...
    */
    ...
    /**
    * @ORM\OneToMany(targetEntity="ServicePurchase", mappedBy="paypalCheckout")
    **/
