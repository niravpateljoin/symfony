 ...
 * @ORM\Entity(repositoryClass="Lost\ServiceBundle\Repository\BillingAddressRepository")
 */
...
class BillingAddress {
    ...
    /**
     *
     * @ORM\ManyToOne(targetEntity="Lost\UserBundle\Entity\User", inversedBy="billingAddress")
