 ...
 * @ORM\Entity(repositoryClass="Lost\UserBundle\Repository\EmailCampaignRepository")
 */
...
class EmailCampaign {
    ...
    */
    ...
    /**
     * @ORM\Column(name="email_status", type="string", columnDefinition="ENUM('Inactive', 'Active', 'Sending', 'Sent')", options={"default":"Inactive"})
     */
