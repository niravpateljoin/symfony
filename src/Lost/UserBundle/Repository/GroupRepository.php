...
// 	    echo $name;exit;
	...
	public function getPermissionArr($group) {
	    $permissionArr = array();
	    $permissions = $group->getPermissions();
	    
	    foreach($permissions as $permission) {
	        $permissionArr[$permission->getId()] = $permission->getId();
	    }
	    
	    return $permissionArr;
	}
	
	public function getAllGroupSearch($query, $search) {

	    if(isset($search['searchTxt']) && !empty($search['searchTxt'])){
	
	        $query->andWhere('c.title LIKE :name');
