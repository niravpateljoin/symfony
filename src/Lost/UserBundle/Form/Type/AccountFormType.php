...
//                    'required' => true))
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder
                ...
                ->add('username', null, array('label' => 'form.username', 'read_only' => $builder->getData()->getId() ? true : false, 'translation_domain' => 'FOSUserBundle', 'read_only' => true, 'required' => true))
    ...
    public function getName() {
        return 'lost_user_account_update';
    }
